import plavchan_gpu as plavchan
import numpy as np
import matplotlib.pyplot as plt
from time import time

times = [np.linspace(0,90,1000).tolist()]*4
mags = [np.sin(times[0]).tolist()]*4
...
t1 = time()
pgram = plavchan.plavchan_pgram(mags, times, trialperiods, width)[0]
t2 = time()
